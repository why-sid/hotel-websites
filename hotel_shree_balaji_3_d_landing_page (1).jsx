...
// Clean, corrected React single-file landing page for Hotel Shree Balaji
// Tailwind CSS utility classes are assumed to be available.
// This version fixes JSX issues and correctly maps over `places` to render map links and buttons.
...
export default function HotelShreeBalajiSimple() {
  ...
  // Places with maps (updated per user's links)
  const places = [
    { name: "Kaal Bhairav Temple", note: "Walking distance — major USP", map: "https://maps.app.goo.gl/B1WqH4GwCsLyiE1NA" },
    { name: "Dashashwamedh Ghat", note: "Evening aarti & boat rides", map: "https://maps.app.goo.gl/hBHaamDDYvHEH9QL6" },
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-md bg-amber-500 flex items-center justify-center shadow-inner overflow-hidden">
              <img src="https://i.postimg.cc/GHzLw0hY/illustration-of-naamam-a-sacred-symbol-of-vaishnavite-in-india-vector.jpg" alt="Tirupati Balaji" className="w-10 h-10 object-cover" />
            </div>
            <div>
                ...
                <div key={p.name} className="p-4 border rounded-lg bg-white">
                  <div className="flex items-start">
                    ...
                    <div className="flex items-center gap-3 ml-auto">
                      {/* walking distance before map */}
                      

                      {/* Boat ride button before map */}
                      {p.name === 'Dashashwamedh Ghat' && (
                      ...
                      {/* Google Maps icon last on right */}
